...
const (
	...
	LOG_ARTICLE_LIST_BYCOLUMN_SUCCESS    = "[ARTICLE_LIST_BYCOLUMN_SUCCESS]: %s"
	LOG_ARTICLE_RELEASE_SUCCESS          = "[ARTICLE_RELEASE_SUCCESS]: %s"
	LOG_ARTICLE_GETWILLBERELEASE_SUCCESS = "[ARTICLE_GETWILLBERELEASE_SUCCESS]: %s"
	LOG_ARTICLE_GETRELEASELIST_SUCESS    = "[ARTICLE_GETRELEASELIST_SUCESS]: %s"
	LOG_ARTICLE_RELEASEFAILD_SUCCESS     = "[ARTICLE_RELEASEFAILD_SUCCESS]: %s"
	LOG_ARTICLE_GETWILLBESUB_SUCCESS     = "[ARTICLE_GETWILLBESUB_SUCCESS]: %s"
	LOG_ARTICLE_GETFOREDIT_SUCCESS       = "[ARTICLE_GETFOREDIT_SUCCESS]: %s"
	LOG_ARTICLE_EDIT_SUCCESS             = "[ARTICLE_EDIT_SUCCESS]: %s"

	LOG_ARTICLE_ADD_ERR    = "[ARTICLE_ADD_ERR]: %s"
	LOG_ARTICLE_DELETE_ERR = "[ARTICLE_DELETE_ERR]: %s"

	LOG_ARTICLE_EDIT_ERR             = "[ARTICLE_EDIT_ERR]: %s"
	LOG_ARTICLE_GETFOREDIT_ERR       = "[ARTICLE_GETFOREDIT_ERR]: %s"
	...
	LOG_ARTICLE_GETWILLBERELEASE_ERR = "[ARTICLE_GETWILLBERELEASE_ERR]: %s"
	...
	LOG_COLUMN_CNAME_SUCCESS = "[COLUMN_CNAME_SUCCESS]: %s"
	...
	LOG_COLUMN_LIST_SUCCSEE  = "[COLUMN_LIST_SUCCSEE]: %s"
	...
	LOG_TAG_DEL_SUCCESS   = "[TAG_DEL_SUCCESS]: %s"
	LOG_TAG_ADD_SUCCESS   = "[TAG_ADD_SUCCESS]: %s"
	LOG_TAG_CNAME_SUCCESS = "[TAG_CNAME_SUCCESS]: %s"
	//数据库错误
